  ...
  return (
    ...
    >
      <Tab.Screen name="Dashboard" component={DashboardScreen}
        options={{ tabBarLabel: 'Tổng quan', tabBarIcon: () => <Text style={{ fontSize: 20 }}>📊</Text> }} />
      <Tab.Screen name="Rooms" component={RoomsScreen}
        options={{ tabBarLabel: 'Phòng', tabBarIcon: () => <Text style={{ fontSize: 20 }}>🏠</Text> }} />
      <Tab.Screen name="Customers" component={CustomersScreen}
        options={{ tabBarLabel: 'Khách hàng', tabBarIcon: () => <Text style={{ fontSize: 20 }}>👥</Text> }} />
      <Tab.Screen name="Staff" component={StaffScreen}
        options={{ tabBarLabel: 'Nhân viên', tabBarIcon: () => <Text style={{ fontSize: 20 }}>👨‍💼</Text> }} />
    </Tab.Navigator>
  );
}
  ...
  return (
    ...
    >
      <Tab.Screen name="StaffRooms" component={StaffRoomsScreen}
        options={{ tabBarLabel: 'Tổng quan phòng', tabBarIcon: () => <Text style={{ fontSize: 20 }}>🏠</Text> }} />
  ...
  return (
    ...
    >
      <Tab.Screen name="TenantHome" component={TenantHomeScreen}
        options={{ tabBarLabel: 'Trang chủ', tabBarIcon: () => <Text style={{ fontSize: 20 }}>🏠</Text> }} />
      <Tab.Screen name="TenantPayment" component={TenantPaymentScreen}
        options={{ tabBarLabel: 'Thanh toán', tabBarIcon: () => <Text style={{ fontSize: 20 }}>💳</Text> }} />
      <Tab.Screen name="TenantReport" component={TenantReportScreen}
        options={{ tabBarLabel: 'Báo sự cố', tabBarIcon: () => <Text style={{ fontSize: 20 }}>🔧</Text> }} />
    </Tab.Navigator>
  );
}
